...
def get_coordinates(paths: list) -> str:
    """given list of paths returns a list of cartesian coordinates"""
    co_list = [ORIGIN]
    prev_co = ORIGIN
    nav = {
        'R': (1,0),
